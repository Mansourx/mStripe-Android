...
public final class BecsDebitWidgetBinding implements ViewBinding {
  ...
  private BecsDebitWidgetBinding(@NonNull View rootView,
      ...
      @NonNull BecsDebitBsbEditText bsbEditText, @NonNull IconTextInputLayout bsbTextInputLayout,
  ...
  public static BecsDebitWidgetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      BecsDebitAccountNumberEditText accountNumberEditText = rootView.findViewById(id);
      if (accountNumberEditText == null) {
        break missingId;
      }

      id = R.id.account_number_text_input_layout;
      TextInputLayout accountNumberTextInputLayout = rootView.findViewById(id);
      if (accountNumberTextInputLayout == null) {
        break missingId;
      }

      id = R.id.bsb_edit_text;
      BecsDebitBsbEditText bsbEditText = rootView.findViewById(id);
      if (bsbEditText == null) {
        break missingId;
      }

      id = R.id.bsb_text_input_layout;
      IconTextInputLayout bsbTextInputLayout = rootView.findViewById(id);
      if (bsbTextInputLayout == null) {
        break missingId;
      }

      id = R.id.email_edit_text;
      EmailEditText emailEditText = rootView.findViewById(id);
      ...
      BecsDebitMandateAcceptanceTextView mandateAcceptanceTextView = rootView.findViewById(id);
      if (mandateAcceptanceTextView == null) {
        break missingId;
      }

      id = R.id.name_edit_text;
      StripeEditText nameEditText = rootView.findViewById(id);
      if (nameEditText == null) {
        break missingId;
      }

      id = R.id.name_text_input_layout;
      TextInputLayout nameTextInputLayout = rootView.findViewById(id);
